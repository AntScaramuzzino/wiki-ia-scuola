...
- la descrizione dell'attuazione delle **misure di sorveglianza umana** ([[concept/supervisione-umana|Supervisione umana (human-in-the-loop)]]), secondo le istruzioni per l'uso;
...
- Nella PA vale lo stesso schema: i deployer pubblici svolgono la FRIA nei casi previsti e la matrice AgID (AIIA) la operazionalizza (vedi [[concept/ia-pubblica-amministrazione|IA nella Pubblica Amministrazione]]).
- Software guidati (es. quelli citati da AgID/Federprivacy) accompagnano passo-passo la compilazione di DPIA/FRIA.

## Relazioni con altri concetti
- [[concept/dpia-fria|DPIA e FRIA — valutazioni d'impatto]] — quadro d'insieme delle due valutazioni; la FRIA **integra** la DPIA
- [[concept/ai-act-categorie-rischio|AI Act — categorie di rischio]] — la FRIA è attivata dalla categoria "alto rischio"
- [[concept/privacy-protezione-dati|Privacy e protezione dei dati]] — la DPIA (art. 35 GDPR) è il presupposto
- [[concept/supervisione-umana|Supervisione umana (human-in-the-loop)]] — le misure di oversight sono contenuto obbligatorio della FRIA
- [[concept/deployer|Deployer (utilizzatore professionale di IA)]] — l'obbligo grava sul deployer (la scuola)
- [[concept/governance-scolastica-ia|Governance scolastica dell'IA]] — la FRIA è uno snodo della governance d'istituto
- [[concept/valutazione-integrita-accademica|Valutazione e integrità accademica]] — i sistemi di valutazione sono il caso d'uso tipico

## Contraddizioni e dibattiti
- **Difficile attuabilità per le scuole**: più fonti ([[source/linee-guida-ia-a-scuola-aspetti-normativi-e-operativi|Linee Guida IA a Scuola: Aspetti Normativi e Operativi (webinar)]]) sostengono che la scuola-deployer non dispone delle informazioni interne dei fornitori (Google, Microsoft) necessarie a una FRIA "a regola d'arte".
- **Adempimento vs processo conoscitivo**: alcune fonti ([[source/l-intelligenza-artificiale-nella-pubblica-amministrazio|L'IA nella PA e nelle imprese: AgID, AI Act e strumenti per le valutazioni d'impatto (Federprivacy)]]) insistono che FRIA e DPIA non sono meri adempimenti, ma processi che migliorano equità e fiducia — a patto di competenze e strumenti adeguati.
...
## Fonti
[[source/ai-act-ue|AI Act — Regolamento (UE) 2024/1689]], [[source/linee-guida-mim-dm166-2025|Linee Guida MIM per l'IA a scuola (DM 166/2025)]], [[source/presentazione-ia-scuola|Presentazione IA Scuola — privacy, DPIA e FRIA]], [[source/valutazione-d-impatto-dell-intelligenza-artificiale-agi|AgID — Valutazione d'impatto dell'Intelligenza Artificiale (AIIA), v1.0 2025]], [[source/l-intelligenza-artificiale-nella-pubblica-amministrazio|L'IA nella PA e nelle imprese: AgID, AI Act e strumenti per le valutazioni d'impatto (Federprivacy)]], [[source/linee-guida-ia-a-scuola-aspetti-normativi-e-operativi|Linee Guida IA a Scuola: Aspetti Normativi e Operativi (webinar)]], [[source/ai-act-digital-omnibus-2026|AI Act e Digital Omnibus: applicazione e rinvii (agosto 2026)]]