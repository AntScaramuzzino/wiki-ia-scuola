...
- **Istruzione** — il compito specifico richiesto all'IA.
- **Contesto** — le informazioni di sfondo (es. "scrivi per alunni di terza media").
- **Dati di input** — le informazioni su cui l'IA deve basarsi.
- **Formato dell'output** — la lunghezza, lo stile o il tono desiderato.

Una strategia efficace consiste nel partire con istruzioni semplici e ottimizzare il prompt in modo iterativo, aggiungendo dettagli in base ai risultati ottenuti.
