---
title: "Explainable AI (IA spiegabile)"
type: concept
...
## Come funziona
Si contrappongono modelli *white-box* (intrinsecamente interpretabili) e *black-box* (accurati ma opachi). Esiste un **trade-off** tra accuratezza e interpretabilità: i modelli più potenti tendono a essere meno spiegabili. In educazione, la spiegabilità è precondizione per la **supervisione umana** consapevole e per contestare una decisione automatizzata.

## Applicazioni o esempi
- Diritto di studenti, docenti e famiglie a comprendere le decisioni algoritmiche che li riguardano (es. una valutazione assistita da IA).
