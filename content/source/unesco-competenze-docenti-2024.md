...
type: source
tags: [ai, competenze, educazione, pedagogia, ai-formazione, formazione]
created: 2026-06-21
updated: 2026-06-21
sources: ["UNESCO AI Competency Framework for Teachers (2024)"]
---

**File raw**: `raw/papers/2024-unesco-ai-competency-framework-for-teachers-cedefop.md`
...
- Destinatari: docenti, decisori politici, fornitori di programmi di formazione per insegnanti, dirigenti scolastici.
- Quattro aspetti di competenza:
  - **Etica dell'IA** — comprensione e applicazione di valori etici, normative e regole pratiche per un uso sicuro e responsabile.
  - **Fondamenti e applicazioni dell'IA** — conoscenza concettuale e abilità operative per capire come funziona l'IA, valutandone appropriatezza e limiti nei contesti educativi.
  - **Pedagogia dell'IA** — integrare eticamente l'IA nei metodi pedagogici (preparazione lezioni, insegnamento, socializzazione, valutazione) mantenendo un approccio incentrato sull'uomo.
